      ...
      <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl max-w-md w-full border border-white/20 shadow-2xl">
        <div className="p-6 border-b border-white/10">
          <div className="flex justify-between items-center">
            <h2 className="text-2xl font-bold text-white">Withdraw {token.name}</h2>
          ...
          {!txResult && !txError ? (
            <>
              ...
              <div className="mb-6">
                <div className="flex justify-between mb-2">
                  ...
                  <span className="text-sm text-gray-400">
                    Supplied: {parseFloat(token.userTokenLentAmount?.amount || 0).toFixed(4)}
                  </span>
                </div>
                <div className="relative">
                  <input
                    ...
                    placeholder="0.00"
                    className="w-full bg-white/5 border border-white/20 rounded-xl px-4 py-4 text-white text-xl focus:outline-none focus:border-red-500 transition"
                  />
                  <button
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-red-500 to-orange-600 hover:from-red-600 hover:to-orange-700 disabled:from-gray-600 disabled:to-gray-700 text-white py-4 rounded-xl font-bold text-lg transition-all shadow-lg disabled:cursor-not-allowed"
              >
                {isLoading ? (
            ...
            <div className="text-center py-8">
              ...
              <p className="text-gray-400 mb-4">Tokens withdrawn successfully</p>
              <a
