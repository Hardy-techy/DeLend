      ...
      <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl max-w-md w-full border border-white/20 shadow-2xl">
        ...
        <div className="p-6 border-b border-white/10">
          <div className="flex justify-between items-center">
            <h2 className="text-2xl font-bold text-white">Supply {token.name}</h2>
            <button
              onClick={onClose}
        ...
        <div className="p-6">
          {!txResult && !txError ? (
            <>
              ...
              <div className="mb-6">
                <div className="flex justify-between mb-2">
                  ...
                  <span className="text-sm text-gray-400">
                    Balance: {parseFloat(token.walletBalance?.amount || 0).toFixed(4)}
                  </span>
                </div>
              ...
              <div className="bg-white/5 rounded-xl p-4 mb-6 space-y-2">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className="text-white">Can be used as collateral</span>
                </div>
              </div>
            ...
            <div className="text-center py-8">
              ...
              <h3 className="text-2xl font-bold text-white mb-2">Supply Successful!</h3>
              <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-4 mb-4">
                <p className="text-green-400 font-bold text-xl">{amount} {token.name}</p>
                <p className="text-gray-400 text-sm mt-1">
                  ≈ ${(parseFloat(amount) * token.oneTokenToDollar).toFixed(2)}
                </p>
              </div>
              <p className="text-gray-400 mb-4">Your tokens have been supplied successfully</p>
              <a
